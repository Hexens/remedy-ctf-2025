...
- [ChainLight](https://github.com/theori-io/ctf/tree/master/2025/remedyctf)

## Running it locally

1. Install Docker.
2. Run the infrastructure in `paradigm-ctf-infrastructure/paradigmctf.py` with `docker compose up -d`.
